...
$sql = "SELECT users.profilePicture, users.firstName, users.lastName, users.birthdate, users.city, users.hobbies 
        ...
        UNION
        SELECT users.profilePicture, users.firstName, users.lastName, users.birthdate, users.city, users.hobbies 
        FROM friend_requests 
            ...
            <div class="container1">
                ...
                <div class="user-container">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<p>עדיין אין אף אחד ברשימת החברים שלך</p>';
                        echo '<p>מעוניין להכיר אנשים חדשים? לחץ על <a href="findingMatches.html">חיפוש חברים</a></p>';
                    }
                    ?>
                </div>
            </div>
