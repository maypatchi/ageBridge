document.addEventListener("DOMContentLoaded", function () {
    ...
    // פונקציה לבדיקת בחירת תחביבים
    function checkHobbies() {
        let checkboxes = document.getElementsByName('hobbies[]');
        hobbiesSelected = false; // איפוס המשתנה לפני בדיקה מחדש
        ...
        if (hobbiesSelected) {
            // אם נבחרו תחביבים, הסתרת ההודעה שיש לבחור תחביב אחד לפחות
            document.getElementById('hobbiesRequiredNote').classList.add('hidden');
        } else {
            // אם לא נבחרו תחביבים, הצגת ההודעה שיש לבחור תחביב אחד לפחות
            document.getElementById('hobbiesRequiredNote').classList.remove('hidden');
        }
    }

    // ביצוע בדיקת בחירת תחביבים בעת שינוי באחד מהתיבות
    let checkboxes = document.getElementsByName('hobbies[]');
    for (let checkbox of checkboxes) {
